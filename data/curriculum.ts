...
export const curriculum: CurriculumItem[] = [
  ...
  },
  {
    ...
    targetScreen: Screen.MENU_CATEGORY,
    subItems: [
      { id: 'combinations-aa', title: 'آ ا', targetScreen: Screen.COMBINATIONS_VIEW },
      { id: 'combinations-oo', title: 'او', targetScreen: Screen.COMBINATIONS_VIEW },
      { id: 'combinations-y', title: 'ی ای', targetScreen: Screen.COMBINATIONS_VIEW },
      { id: 'combinations-a', title: 'اَ ـَ', targetScreen: Screen.COMBINATIONS_VIEW },
      { id: 'combinations-e', title: 'اِ ـِ ه', targetScreen: Screen.COMBINATIONS_VIEW },
      { id: 'combinations-o', title: 'اُ ـُ', targetScreen: Screen.COMBINATIONS_VIEW },
  ...
  },
  {
    ...
    targetScreen: Screen.MENU_CATEGORY,
    subItems: [
      { id: 'word-reading-1', title: 'سطح ۱', targetScreen: Screen.WORD_READING_LEVEL },
      { id: 'word-reading-2', title: 'سطح ۲', targetScreen: Screen.WORD_READING_LEVEL },
      { id: 'word-reading-3', title: 'سطح ۳', targetScreen: Screen.WORD_READING_LEVEL },
      { id: 'word-reading-4', title: 'سطح ۴', targetScreen: Screen.WORD_READING_LEVEL },
  ...
  },
  {
    ...
    targetScreen: Screen.MENU_CATEGORY,
    subItems: [
      { id: 'sentence-reading-1', title: 'سطح ۱', targetScreen: Screen.SENTENCE_READING_LEVEL },
      { id: 'sentence-reading-2', title: 'سطح ۲', targetScreen: Screen.SENTENCE_READING_LEVEL },
      { id: 'sentence-reading-3', title: 'سطح ۳', targetScreen: Screen.SENTENCE_READING_LEVEL },
      { id: 'sentence-reading-4', title: 'سطح ۴', targetScreen: Screen.SENTENCE_READING_LEVEL },
